...
public class TestInsertTwoPersonsUseTransaction {
	...
	public static void main(String[] args) {
    	...
    	System.out.println("\n======================testInsertTwoPersonsUseTransaction(p) begin======================\n");
    	service.testInsertTwoPersonsUseTransaction(p);
    	System.out.println("\n======================testInsertTwoPersonsUseTransaction(p) end======================\n");
