...
public class SqlMapClientTemplate extends JdbcAccessor implements SqlMapClientOperations {
	...
	public SqlMapClientTemplate(SqlMapClient sqlMapClient) {
		System.out.println("SqlMapClientTemplate -- construct 1");
	...
	public SqlMapClientTemplate(DataSource dataSource, SqlMapClient sqlMapClient) {
		System.out.println("SqlMapClientTemplate -- construct 2");
	...
	public void setSqlMapClient(SqlMapClient sqlMapClient) {
		System.out.println("SqlMapClientTemplate -- setSqlMapClient()");
	...
	public void afterPropertiesSet() {
		System.out.println("SqlMapClientTemplate -- afterPropertiesSet()");
	...
	public <T> T execute(SqlMapClientCallback<T> action) throws DataAccessException {
		...
		System.out.println("SqlMapClientTemplate -- execute(...)");
		...
		try {
			...
			System.out.println("SqlMapClientTemplate -- execute(...) dataSource : " + dataSource.getClass().getName());
			System.out.println("SqlMapClientTemplate -- execute(...) transactionAware : " + transactionAware);
